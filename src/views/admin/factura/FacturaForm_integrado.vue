    ...
    <div class="card mb-3">
      <div class="card-body">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h4 class="mb-1">
              Factura {{ factura.fac_codigo || 'NUEVA' }}
            </h4>
            <span
              class="badge"
            ...
            <div v-if="isNueva" class="row mt-3 g-3">
              <div class="col-md-6">
                ...
                <select v-model="clienteSeleccionado" class="form-select">
                  ...
                  <option v-for="c in clientes" :key="c.cli_codigo" :value="c">
                    {{ c.cli_ruc_cedula }} - {{ c.cli_nombre }}
                  </option>
                </select>
              </div>
...
// ✅ AÑADIDO: cargar clientes para FACTURA NUEVA
const loadClientes = async () => {
  try {
    const res = await ClienteService.getAll()
    // respeta tu estándar data.data si aplica
